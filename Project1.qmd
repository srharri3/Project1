...
```{r}
plot.census <- function(test_results_formatted, numVar, catVar) {
...
```{r}
plot.census(test_results_formatted, "AGEP", "HISPEED")
```
<<<<<<< HEAD

Investigating Something Interesting From the Data 
=======
>>>>>>> 7e911077b1cf029e1fad1a33c15763f0e33ff0c6
