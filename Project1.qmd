...
#print(colName)      
      ...
      if (varName == colName) {
        ...
        #get lookup data
        #print(paste("calling get Lookup with vars:",varName,year))
        ...
        if (varName %in% numeric_variables) {
          ...
          print(as.numeric(results[[varName]]))
          print(varName)
          print(results[varName])
          results[varName] <- mutate(results[varName],varName = as.numeric(results[[varName]]))
          print(head(results))
        }
